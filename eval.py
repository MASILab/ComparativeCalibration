...
# python eval.py --cfg config/cifar10_trvaltt/cifar10_stage1_mixup0.2.yaml  resume /media/gaor2/Elements/saved_file/Calibration/MiSLAS/imb1/stage1_mixup0.2/ckps/model_best.pth.tar


# python eval.py --cfg config/cifar10_trvaltt/cifar10_stage1_mixup0.2.yaml  resume /media/gaor2/Elements/saved_file/Calibration/MiSLAS/imb1/stage1_mixup0.2/ckps/model_best.pth.tar

# python eval.py --cfg config/cifar10_trvaltt/cifar10_premixup0.2_stage2las.yaml  resume /media/gaor2/Elements/saved_file/Calibration/MiSLAS/imb1/premixup0.2_stage2las/ckps/model_best.pth.tar

# python eval.py --cfg config/cifar10_trvaltt/cifar10_stage1_mixup0.2_focal.yaml  resume /media/gaor2/Elements/saved_file/Calibration/MiSLAS/imb1/stage1_mixup0.2_focal/ckps/model_best.pth.tar

# python eval.py --cfg config/cifar10_trvaltt/cifar10_premixup0.2focal_stage2las.yaml  resume /media/gaor2/Elements/saved_file/Calibration/MiSLAS/imb1/premixup0.2focal_stage2las/ckps/model_best.pth.tar
...
def validate(val_loader, model, classifier, lws_model, criterion, config, logger, block=None):
    ...
    with torch.no_grad():
        ...
        np.save(config.log_dir.replace('logs', '') + 'test_confid.npy', confidence)
        np.save(config.log_dir.replace('logs', '') + 'test_pred.npy', pred_class)
        np.save(config.log_dir.replace('logs', '') + 'test_true.npy', true_class)
